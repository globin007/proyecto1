...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Validación de bicicletas</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Validación de bicicletas</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      ...
      <div id="listado" class="card card-default">
        ...
        <div class="card-header">
          <h3 class="card-title">Lista de Bicicletas en Evaluación</h3>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label>Marca</label>
                  <input id="marca" placeholder="Escriba la marca..." name="marca" class="form-control" style="width: 100%;" required readonly>
                </div>
              </div>    
            </div>
            <!-- fin Fila --> 
