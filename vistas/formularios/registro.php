            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombres" id="nombres" maxlength="50" placeholder="Nombres" required readonly>
                </div>
              </div>       
            </div>
            <!-- fin Fila --> 
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="apepaterno" id="apepaterno" maxlength="50" placeholder="Apellido Paterno" required readonly>
                </div>              
              </div> 
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label>Apellido Materno</label>
                  <input type="text" class="form-control" name="apematerno" id="apematerno" maxlength="50" placeholder="Apellido Materno" required readonly>
                </div>
              </div>           
            </div>
            <!-- fin Fila --> 
