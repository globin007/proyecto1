...
Class Validacion
{
	...
	public function listar()
	{
		...
		$sql="SELECT b.id_bicicleta, u.nombres, u.apepaterno, b.marca, b.modelo, b.color, b.ganancia, e.descripcion as 'estado', e.id_estado, b.imagen FROM bicicleta b INNER JOIN usuario u ON b.id_usuario = u.id_usuario INNER JOIN estado_bicicleta e ON b.id_estado = e.id_estado where b.id_estado=1" ;
